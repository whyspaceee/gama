    ...
    >
      <div className=" flex h-full flex-row items-center justify-between px-4">
        ...
        <Link href = '/customer'
          ...
          style={{ boxShadow: "0px 0px 18px rgba(0, 0, 0, 0.25)" }}
        >
          <IoCar className=" h-6 w-6 fill-main" />
        </Link>

        <div className=" flex w-1/3 flex-row items-center justify-between">
        <Link href='/customer/orders' className=" group flex h-10 w-10  items-center justify-center rounded-full bg-main transition-all active:bg-white no_highlights "> 
