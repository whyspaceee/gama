...
import { IoAnalyticsOutline, IoFastFoodOutline, IoGitBranch, IoGitBranchOutline, IoThumbsUpOutline, IoThumbsUpSharp } from "react-icons/io5"
  ...
  return (
    ...
    >
      <div className=" w-full font-semibold">
        ...
        <h2 className=" text-base font-bold">Nasi Goreng Padmanaba</h2>
      </div>
      <div className=" h-32 w-full rounded-lg bg-black bg-gradient-to-r p-4 font-semibold text-white shadow-xl ">
      ...
      <div className=" w-full">
        ...
        <div className=" grid w-full grid-cols-4 justify-center gap-4">
          ...
          <IconButton Icon={MdOutlineThumbUpOffAlt} label="Feedback" delay={1} />
          <IconButton Icon={MdOutlineSpeakerGroup} label="Ads" delay={1.2} />
        </div>
      </div>
    </motion.main>
    <BottomBar />
